# Baseline配置 - LSS (Lift-Splat-Shoot) Transformer for nuScenes
...
# 模型配置 - 使用LSS Transformer（baseline方法）
backbone_norm_cfg = dict(type='LN', requires_grad=True)
model = dict(
    type='BEVSegmentor',  # 使用BEVSegmentor（支持transformer和calib，不包含diffusion）
