...
class EncoderDecoder(BaseSegmentor):
    ...
    def __init__(self,
        ...
        # 初始化_init_decode_head和_init_auxiliary_head的参数
    ...
    # 将image经过backcbone，如果有neck再经过neck
    ...
    def encode_decode(self, img, img_metas):
        ...
        # self._decode_head_forward_test for inference,没有loss的反传
        out = self._decode_head_forward_test(x, img_metas)
        # 将输出用双线性插值成跟输入的image相同的shape
        out = resize(
            input=out,
            size=img.shape[2:],
            mode='bilinear',
